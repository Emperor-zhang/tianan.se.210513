            ...
            >
              ...
              >
                <image
                  class="header_icon"
                  v-if="isWhite"
                  src="https://wb.jaas.ac.cn/SmallExePic/love.se.210301/img/back.png"
                  mode="aspectFit"
                ></image>
                <image
                  class="header_icon"
            ...
            >
              ...
              >
                <image
                  class="header_icon"
                  v-if="isWhite"
                  src="/static/zhouWei-navBar/icon_back_white.png"
                  mode="aspectFit"
                ></image>
                <image
                  class="header_icon"
                  v-else
                  src="/static/zhouWei-navBar/icon_back_black.png"
                  mode="aspectFit"
                ></image>
              </view>
              ...
              >
                <image
                  class="header_icon"
                  v-if="isWhite"
                  src="/static/zhouWei-navBar/icon_home_white.png"
                  mode="aspectFit"
                ></image>
                <image
                  class="header_icon"
                  v-else
                  src="/static/zhouWei-navBar/icon_home_black.png"
                  mode="aspectFit"
                ></image>
              </view>
            </view>
