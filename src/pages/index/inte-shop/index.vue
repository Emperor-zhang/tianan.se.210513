<template>
  <view class="content">
    <image :src="$url + 'index/10-1.png'" mode="widthFix"></image>
    <image
      :src="$url + '/weChat.jpeg'"
      mode="widthFix"
...
export default {
  ...
  methods: {
    ...
    shopInfo() {
      uni.navigateTo({
        url: `/pages/index/inte-shop/goods-detail/index`,
      });
    },
    // 积分规则
    rule() {
      uni.navigateTo({
        url: `/pages/index/inte-shop/rule/index`,
      });
    },
  },
};
